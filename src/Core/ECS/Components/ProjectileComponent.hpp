...
namespace TouhouFanGame::ECS::Components
{
	...
	public:
		...
		ProjectileComponent(Game &game, std::string modulePath, unsigned damages = 0, unsigned lifeTime = -1, std::weak_ptr<Entity> entity = {}, const std::vector<std::string> &&targets = {});
