...
namespace TouhouFanGame::ECS::Systems
{
	...
	void BlockedByTerrainSystem::_pushEntity(TouhouFanGame::ECS::Components::PositionComponent &pos, float x, float y, unsigned char tileSize, float &dir, float &speed)
	{
